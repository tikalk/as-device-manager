...
ft-device-manager/build/distributions/ft-device-manager-3.1.0.zip
...
Unzip the file ft-device-manager/build/distributions/ft-device-manager-3.1.0.zip
cd to the created folder (ft-device-manager-3.1.0)
